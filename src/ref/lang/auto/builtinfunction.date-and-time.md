...
| Name | Description |
| :--- | :--- |
| [AddDays](builtinfunction.date-and-time.md#AddDays)\(​DateTime, Integer\) | Adds 'n' days to 'dt' and returns a valid Date Time. |
| [AddHours](builtinfunction.date-and-time.md#AddHours)\(​DateTime, Integer\) | Adds 'n' hours to 'dt' and returns a valid Date Time. |
| [AddMinutes](builtinfunction.date-and-time.md#AddMinutes)\(​DateTime, Integer\) | Adds 'n' minutes to 'dt' and returns a valid Date Time. |
| [AddMonths](builtinfunction.date-and-time.md#AddMonths)\(​DateTime, Integer\) | Adds 'n' months to 'dt' and returns a valid Date Time. |
| [AddSeconds](builtinfunction.date-and-time.md#AddSeconds)\(​DateTime, Integer\) | Adds 'n' seconds to 'dt' and returns a valid Date Time. |
| [AddYears](builtinfunction.date-and-time.md#AddYears)\(​DateTime, Integer\) | Adds 'n' years to 'dt' and returns a valid Date Time. |
| [BuildDateTime](builtinfunction.date-and-time.md#BuildDateTime)\(​Date, Time\) | Returns a Date Time made up of the Date 'd' and Time 't'. |
| [CurrDate](builtinfunction.date-and-time.md#CurrDate)\(\) | In client-side calls, it returns the device date. In server-side calls, it returns the platform server date. In query calls, it returns the platform server date. |
| [CurrDateTime](builtinfunction.date-and-time.md#CurrDateTime)\(\) | In client-side calls, it returns the device date and time. In server-side calls, it returns the platform server date and time. In query calls, it returns the platform server date and time.  Date times in the device are converted in the server to the server time zone. Conversely, date times in the server are converted in the device to the device time zone. |
| [CurrTime](builtinfunction.date-and-time.md#CurrTime)\(\) | In client-side calls, it returns the device time. In server-side calls, it returns the platform server time. In query calls, it returns the platform server time. |
| [Day](builtinfunction.date-and-time.md#Day)\(​DateTime\) | Returns the day of 'dt'. |
| [DayOfWeek](builtinfunction.date-and-time.md#DayOfWeek)\(​DateTime\) | Returns the week day of 'dt', ranging from 0 \(Sunday\) to 6 \(Saturday\). |
| [DiffDays](builtinfunction.date-and-time.md#DiffDays)\(​DateTime, DateTime\) | Returns the difference in days between 'dt1' and 'dt2'; i.e. how many days have passed between these two dates:  - Returns a positive number if 'dt1' is smaller than 'dt2'; - Returns a negative number if 'dt1' is bigger than 'dt2'; - Returns 0 if the two dates are equal.  The Time component you provide in the parameters is ignored. The DiffDays function receives two Date Time parameters, and then replaces the Time component with 00:00:00. It calculates the elapsed time in milliseconds from the first date at 00:00:00 to the second date at 00:00:00, and then converts the difference in milliseconds into days.  Daylight Saving Time \(DST\) is ignored. The time zone considered for evaluating this function is always the time zone of the Platform Server, regardless of the regional settings of the end-user.  The maximum supported value is \(2^31\)-1 days. This corresponds to approximately 5879489.8 years. If DiffDays\(dt1, dt2\) is bigger than \(2^31\)-1, you will get an unexpected value. |
| [DiffHours](builtinfunction.date-and-time.md#DiffHours)\(​DateTime, DateTime\) | Returns the difference in hours between 'dt1' and 'dt2'; i.e. how many hours have passed between these two dates:  - Returns a positive number if 'dt1' is smaller than 'dt2'; - Returns a negative number if 'dt1' is bigger than 'dt2'. - Returns 0 if the two dates are equal.  Daylight Saving Time \(DST\) is ignored. The time zone considered for evaluating this function is always the time zone of the Platform Server, regardless of the regional settings of the end-user.  The maximum supported value is \(2^31\)-1 hours. This corresponds to approximately 244978.74 years. If DiffHours\(dt1, dt2\) is bigger than \(2^31\)-1, you will get an unexpected value. |
| [DiffMinutes](builtinfunction.date-and-time.md#DiffMinutes)\(​DateTime, DateTime\) | Returns the difference in minutes between 'dt1' and 'dt2'; i.e. how many minutes have passed between these two dates:  - Returns a positive number if 'dt1' is smaller than 'dt2'; - Returns a negative number if 'dt1' is bigger than 'dt2'. - Returns 0 if the two dates are equal.  Daylight Saving Time \(DST\) is ignored. The time zone considered for evaluating this function is always the time zone of the Platform Server, regardless of the regional settings of the end-user.  The maximum supported value is \(2^31\)-1 minutes. This corresponds to approximately 4085.78 years. If DiffMinutes\(dt1, dt2\) is bigger than \(2^31\)-1, you will get an unexpected value. |
| [DiffSeconds](builtinfunction.date-and-time.md#DiffSeconds)\(​DateTime, DateTime\) | Returns the difference in seconds between 'dt1' and 'dt2'; i.e. how many seconds have passed between these two dates:  - Returns a positive number if 'dt1' is smaller than 'dt2'; - Returns a negative number if 'dt1' is bigger than 'dt2'. - Returns 0 if the two dates are equal.  Daylight Saving Time \(DST\) is ignored. The time zone considered for evaluating this function is always the time zone of the Platform Server, regardless of the regional settings of the end-user.  The maximum supported value is \(2^31\)-1 seconds. This corresponds to approximately 68.10 years. If DiffSeconds\(dt1, dt2\) is bigger than \(2^31\)-1, you will get an unexpected value. |
| [Hour](builtinfunction.date-and-time.md#Hour)\(​DateTime\) | Returns the hour of 'dt'. |
| [Minute](builtinfunction.date-and-time.md#Minute)\(​DateTime\) | Returns the minute of 'dt'. |
| [Month](builtinfunction.date-and-time.md#Month)\(​DateTime\) | Returns the month of 'dt'. |
| [NewDate](builtinfunction.date-and-time.md#NewDate)\(​Integer, Integer, Integer\) | Returns a Date made up of year 'y', month 'm' and day 'd'. |
| [NewDateTime](builtinfunction.date-and-time.md#NewDateTime)\(​Integer, Integer, Integer, Integer, Integer, Integer\) | Returns a Date Time made up of year 'y', month 'mo', day 'd', hour 'h', minute 'mi' and second 's'. |
