...
| :--- | :--- |
| Assigned as \*\*Default Role\*\* | The user can open and debug all the \*\*modules of the environment’s applications\*\* in Service Studio. |
| Assigned for a \*\*Team\*\* | The user can open and debug the \*\*modules of the team’s applications\*\* in Service Studio. |
| Assigned for an \*\*Application\*\* | The user can open and debug the \*\*modules of the application\*\* in Service Studio. |
