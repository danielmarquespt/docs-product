...
1. In the Logic tab, add a new Action to your module.
   ...
   ![](https://github.com/danielmarquespt/docs-product/tree/e7ea3f444d5129dab245c69ab72ae091554bc4fb/src/develop/reuse-and-refactor/images/encapsulate-logic-1.png?width=300)

2. Implement the logic in the action flow.

   ![](https://github.com/danielmarquespt/docs-product/tree/e7ea3f444d5129dab245c69ab72ae091554bc4fb/src/develop/reuse-and-refactor/images/encapsulate-logic-2.png?width=600)
...
2. Drag the action with the encapsulated logic from the Logic tab and drop it in the action flow.
   ...
   ![](https://github.com/danielmarquespt/docs-product/tree/e7ea3f444d5129dab245c69ab72ae091554bc4fb/src/develop/reuse-and-refactor/images/encapsulate-logic-3.png?width=600)
